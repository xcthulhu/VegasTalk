...
main :: IO ()
main = do
  let numberOfHorses, numberOfBets, count :: Int
      numberOfHorses = 20
      numberOfBets = 2
      count = 5
  saveRegressionSim numberOfHorses numberOfBets $ printf "sims/bets_%d_%d_%d.json" numberOfHorses numberOfBets count

-- Local Variables:
-- eval: (projectile-mode)
-- projectile-project-compilation-cmd: "./ArbitrageFloatFix.hs"
-- End:
